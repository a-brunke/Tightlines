...
- **Map** — Lake Kagawong with **real MNRF depth contours** (20/40/60/80 ft + the 110 ft basin), GPS waypoints that work with zero cell signal, catch pins, and one-tap offline map download.
- **Log** — catch log with photos, auto GPS, auto weight estimate — feeding the **Kagawong Cup** family derby leaderboard (biggest fish, most fish, most species).
